...
export function getProjectProgress(): ProjectProgress {
  return {
    ...
    overallCompletionRange: '80-82%',
    overallCompletionPct: 81,
    summary: 'Working local foundation is in place with Cloudflare readiness checks, a Postgres schema path, mocked live-provider contract coverage, a cross-platform checkout UI, and a real local payment-intent checkout contract; remaining work is official live provider certification, wallet broadcast, compliance vendors, hosted migration, and operations.',
    workstreams: [
      { id: 'core-api', label: 'Core API and Docker', completionRange: '78-81%', completionPct: 80, status: 'in_progress' },
      ...
      { id: 'console-ux', label: 'Console UX and brand', completionRange: '70-73%', completionPct: 72, status: 'in_progress' },
      { id: 'smoke-coverage', label: 'Smoke coverage', completionRange: '72-75%', completionPct: 74, status: 'in_progress' }
    ],
    nextSlices: [
