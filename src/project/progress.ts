...
export function getProjectProgress(): ProjectProgress {
  return {
    ...
    overallCompletionRange: '78-80%',
    overallCompletionPct: 79,
    summary: 'Working local foundation is in place with Cloudflare readiness checks, a Postgres schema path, mocked live-provider contract coverage, and a cross-platform checkout UI; remaining work is official live provider certification, wallet broadcast, compliance vendors, hosted migration, and operations.',
    workstreams: [
      ...
      { id: 'console-ux', label: 'Console UX and brand', completionRange: '66-70%', completionPct: 68, status: 'in_progress' },
